...
def load_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        '--transform-json', 
        type=argparse.FileType(mode='r', errors=""), 
        dest='transformJson',
        action="store", 
        default=None,
        required=False,
        metavar="<raw_json_file>",
        help="Provide a JSON File emitted by Codefree to transform into a Report.\nIf this is provided, other input options will be ignored",
        )
    ...
    if getattr(args, "includePaths", None) is not None:
